function examples = loadDocDataSnowball(fName, nNet, nPC, jumpRate, seeds, makeEdgeDist, makeCounts, plotNets)
...
for i = 1:nNet
	...
	examples(i) = makeExample(Xnode,Xedge,y(subgraphs(i).nodes),edgeStruct);
