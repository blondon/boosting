function examples = iidNoiseModel(nEx,nFeat,noiseRate,noiseType,scale,makeEdgeDist,makeCounts,makePlots)
%
...
for i = 1:nEx
	...
	examples(i) = makeExample(Xnode(i,:,:),Xedge,Ynode,edgeStruct);
end
